...
default:
	...
	-Wl,-Bstatic -lhiredis -lboost_system -lboost_random -lboost_regex  -lboost_thread -lboost_date_time -lboost_log -lboost_log_setup -lboost_filesystem -lboost_timer -lboost_chrono -Wl,-Bdynamic -lpthread -lm -lcurl -lrt -lmysqlpp -lmysqlclient -lcpp_redis -ltacopie
test:
