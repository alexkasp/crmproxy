...
class Parser: public IParser
{
	...
	string parse_answercall(string src,string dst,string uid,string timestamp,string callid,string calltype,string usecrm);
	string parse_finishcall(string src,string dst,string uid,string timestamp,string callid,string callstart,string callanswer,string status,string calltype,string callbackId,string TreeID,string ChannelName,string serverId,string recordfile,string label,string rating,string usecrm);
